...
<table height="100%">
  <thead>
    <tr class="text-center">
      <th>
        <button tabindex="-1" type="button" class="btn btn-default btn-block" ng-click="$arrowAction(-1, 0)">
          <i class="{{ $iconUp }}"></i>
        </button>
      </th>
      <th>
      ...
      <th>
        <button tabindex="-1" type="button" class="btn btn-default btn-block" ng-click="$arrowAction(-1, 1)">
          <i class="{{ $iconUp }}"></i>
        </button>
      </th>
    </tr>
